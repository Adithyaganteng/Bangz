...
var imgs = await client.prepareMessage('0@c.us', thumb, image, { thumbnail: thumb })
            ...
            var ctlg = await client.prepareMessageFromContent(from, {
                "productMessage": {
                    ...
                    "businessOwnerJid": "6285951332948@s.whatsapp.net",
                }
...
break
case 'sad':
sad = fs.readFileSync('./mp3/Masih.mp3');
...
tod = await getBuffer(`https://telegra.ph/file/93fd4cb214d27997aec65.jpg`)
                 ...
                 case 'script':
                case 'sc':
                reply(`*MINTA OWNER GOBLOK :v 🗿*`)
                break
                case 'yt':
                reply(`*https://youtube.com/channel/UCKFOOTpXeHrVvlU7XEHkiRw*`)
                break
   case 'bokep':
